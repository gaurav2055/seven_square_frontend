...
const Card = () => {
  return (
    ...
    <div className="card-container p-5 ms-sm-5" style={{maxWidth: '600px', maxHeight: '800px'}}>
        <span className="badge bg-primary mb-2 heading-3">Buy</span>
        <p className="heading-2">Hill Crest,16th Road, Bandra West</p>
        <p className='body-2'>16th Road (Bandra, Maharashtra, IN - 400050)</p>

        <p className="heading-3 mb-0">About</p>
        <p className='body-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur blandit congue sodales. Nulla eget ex odio. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo nulla ipsam provident!</p>
